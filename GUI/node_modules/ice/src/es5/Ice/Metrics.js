...
(function (module, require, exports) {
  ...
  IceMX.UnknownMetricsView = /*#__PURE__*/function (_Ice$UserException) {
    ...
    function _class3() {
      ...
      return _super2.call(this, _cause);
    }
  ...
  IceMX.ThreadMetrics = /*#__PURE__*/function (_IceMX$Metrics) {
    ...
    function _class6(id, total, current, totalLifetime, failures) {
      ...
      _this2 = _super5.call(this, id, total, current, totalLifetime, failures);
  ...
  IceMX.DispatchMetrics = /*#__PURE__*/function (_IceMX$Metrics2) {
    ...
    function _class7(id, total, current, totalLifetime, failures) {
      ...
      _this3 = _super6.call(this, id, total, current, totalLifetime, failures);
  ...
  IceMX.ChildInvocationMetrics = /*#__PURE__*/function (_IceMX$Metrics3) {
    ...
    function _class8(id, total, current, totalLifetime, failures) {
      ...
      _this4 = _super7.call(this, id, total, current, totalLifetime, failures);
      _this4.size = size;
  ...
  IceMX.CollocatedMetrics = /*#__PURE__*/function (_IceMX$ChildInvocatio) {
    ...
    function _class9(id, total, current, totalLifetime, failures, size, replySize) {
      ...
      return _super8.call(this, id, total, current, totalLifetime, failures, size, replySize);
    }
  ...
  IceMX.RemoteMetrics = /*#__PURE__*/function (_IceMX$ChildInvocatio2) {
    ...
    function _class10(id, total, current, totalLifetime, failures, size, replySize) {
      ...
      return _super9.call(this, id, total, current, totalLifetime, failures, size, replySize);
    }
  ...
  IceMX.InvocationMetrics = /*#__PURE__*/function (_IceMX$Metrics4) {
    ...
    function _class11(id, total, current, totalLifetime, failures) {
      ...
      _this5 = _super10.call(this, id, total, current, totalLifetime, failures);
      _this5.retry = retry;
  ...
  IceMX.ConnectionMetrics = /*#__PURE__*/function (_IceMX$Metrics5) {
    ...
    function _class12(id, total, current, totalLifetime, failures) {
      ...
      _this6 = _super11.call(this, id, total, current, totalLifetime, failures);
