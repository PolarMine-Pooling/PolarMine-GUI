...
Ice._ModuleRegistry.require(module, ["../Ice/ArrayUtil", "../Ice/BatchRequestQueue", "../Ice/Debug", "../Ice/HashUtil", "../Ice/OpaqueEndpointI", "../Ice/Promise", "../Ice/ReferenceMode", "../Ice/StringUtil", "../Ice/BuiltinSequences", "../Ice/EndpointTypes", "../Ice/Identity", "../Ice/Router", "../Ice/Locator", "../Ice/LocalException", "../Ice/Version", "../Ice/PropertyNames", "../Ice/ConnectionRequestHandler", "../Ice/MapUtil"]);
...
var FixedReference = /*#__PURE__*/function (_Reference) {
  ...
  var _super = _createSuper(FixedReference);
  ...
  function FixedReference(instance, communicator, identity, facet, mode, secure, protocol, encoding, connection, invocationTimeout, context) {
    ...
    _this = _super.call(this, instance, communicator, identity, facet, mode, secure, protocol, encoding, invocationTimeout, context);
...
var RoutableReference = /*#__PURE__*/function (_Reference2) {
  ...
  var _super2 = _createSuper(RoutableReference);
  ...
  function RoutableReference(instance, communicator, identity, facet, mode, secure, protocol, encoding, endpoints, adapterId, locatorInfo, routerInfo, cacheConnection, preferSecure, endpointSelection, locatorCacheTimeout, invocationTimeout, context) {
    ...
    _this2 = _super2.call(this, instance, communicator, identity, facet, mode, secure, protocol, encoding, invocationTimeout, context);
