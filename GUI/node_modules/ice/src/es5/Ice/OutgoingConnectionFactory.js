...
Ice._ModuleRegistry.require(module, ["../Ice/AsyncResultBase", "../Ice/ConnectionI", "../Ice/Debug", "../Ice/HashMap", "../Ice/Promise", "../Ice/EndpointTypes", "../Ice/LocalException", "../Ice/Exception", "../Ice/ACM"]);
...
var ConnectionListMap = /*#__PURE__*/function (_HashMap) {
  ...
  var _super = _createSuper(ConnectionListMap);

  function ConnectionListMap(h) {
    _classCallCheck(this, ConnectionListMap);

    return _super.call(this, h || HashMap.compareEquals);
  }
